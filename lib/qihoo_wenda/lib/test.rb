...
require 'qihoo_wenda'
require 'cgi'
result = QihooWenda.search(CGI.escape("游戏"), :per_page => 10, :page_index => 1)
...
# http://www.qihoo.com/wenda.php?do=search&kw=dsv&src=jc&pos=1&page=1
# http://www.qihoo.com/wenda.php?do=search&kw=dsv&src=jc&pos=1&page=2
# http://www.qihoo.com/wenda.php?do=search&kw=dsv&src=jc&pos=1&page=3
